	...
	<div class="col-sm-4">
		<div id="steamOfficialSelected" class="m-3">
			<h4 class="text-danger pb-2">
				Steam Official appID
				<span class="d-none"><i class="fas fa-arrow-circle-down"></i></span>
			</h4>
...
<div id="alert" class="alert alert-danger text-center">
	If it takes too long, check the console log of browser and open issue on <a
	href="https://github.com/Sak32009/GetDLCInfoFromSteamDB/issues" target="_blank">GitHub</a>.
</div>
				...
				<div class="tab-pane fade show active" id="steam_converter">
					<div class="input-group">
						...
						<label class="btn btn-dark" for="steam_unknowns">
							<input class="form-check-input" type="checkbox" id="steam_unknowns" /> With DLCS Unknowns
						</label>
