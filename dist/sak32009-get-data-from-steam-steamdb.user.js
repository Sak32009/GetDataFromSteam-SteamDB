...
(function(CryptoJS2, $2, bootstrap$1, client) {
  "use strict";
...
`;
  ...
  const version = "4.5.9";
  const bootstrap2 = "";
  const unsafeWindowC = client.unsafeWindow;
...
`;
  ...
  new Sak32009().check();
})(CryptoJS, $, bootstrap, (window.monkeyWindow = window, window));
